...
#define STRING_CONFIG_H_AUTHOR "(Amir Guindehi <amir@datacore.ch>, SecKit SK-Go config)" // Who made the changes.
...
#define MACHINE_UUID "17bcd441-359c-4a12-bb1f-419d8b38f629"
...
#define NOZZLE_TO_PROBE_OFFSET { 37, 12, -0.90 }
